...
DEFAULT_CONFIG = REPO_ROOT / "experiments" / "anomaly_detection" / "teacher_student" / "resnet18" / "x224" / "main" / "train_config.toml"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "experiments" / "anomaly_detection" / "teacher_student" / "resnet18" / "x224" / "main" / "artifacts" / "ts_resnet18_x224"
...
def run_train(config_path: Path, output_dir: Path) -> None:
...
def main() -> None:
    ...
    if args.phase == "train":
        run_train(config_path, output_dir)
