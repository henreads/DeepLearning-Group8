"""Train a convolutional Deep SVDD model on normal wafers only."""
...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/training/train_svdd.toml")
    ...
    if resume_from:
        ...
        print(f"Initialized SVDD center with norm {model.center.norm().item():.6f}")
