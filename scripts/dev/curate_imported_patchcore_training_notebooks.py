...
def update_readme(branch_dir: Path, title: str, summary: str) -> None:
    ...
    content = (
        ...
        f"- Extracted outputs from the earlier saved run are preserved under `[{branch_rel}/artifacts/results/extracted_notebook_outputs]({branch_rel}/artifacts/results/extracted_notebook_outputs)`.\n"
    )
