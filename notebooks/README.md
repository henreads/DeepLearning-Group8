...
- `anomaly_120k_labeled/`
  ...
  Current contents include the root-level WRN50 PatchCore workflow, the report-style normal-only WRN50 retrain notebook, and `ts_resnet50/` for the single-test teacher-student ResNet50 benchmark.
- `classifier/`
