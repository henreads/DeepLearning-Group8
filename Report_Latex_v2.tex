...
\textbf{Best results.} ViT-B/16 PatchCore at direct $224\!\times\!224$ achieves the strongest main-benchmark
result: $\mathrm{F1}=0.595$, $\mathrm{AUROC}=0.956$, $\mathrm{AUPRC}=0.671$. Its advantage over
