...
Key files:
- notebook: `experiments/anomaly_detection/patchcore/wideresnet50/x224/layer3/notebook.ipynb`
- train config: `experiments/anomaly_detection/patchcore/wideresnet50/x224/layer3/train_config.toml`
- artifact root: `experiments/anomaly_detection/patchcore/wideresnet50/x224/layer3/artifacts/patchcore-wideresnet50-layer3`

Artifact layout:
- `results/`: branch-level sweep tables and selected-variant review outputs
- `plots/`: branch-level plots for the selected variant
- `topk_mb50k_r005_l3_x224/`: per-variant results/evaluation/plots generated from cached CSVs
