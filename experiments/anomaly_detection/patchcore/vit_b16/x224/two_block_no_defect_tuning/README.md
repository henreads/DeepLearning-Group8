...
- Extracted outputs from the earlier saved run are preserved under `[experiments/anomaly_detection/patchcore/vit_b16/x224/two_block_no_defect_tuning/artifacts/results/extracted_notebook_outputs](experiments/anomaly_detection/patchcore/vit_b16/x224/two_block_no_defect_tuning/artifacts/results/extracted_notebook_outputs)`.
