...
Key files:
- notebook: `experiments/anomaly_detection/patchcore/resnet18/x64/main/notebook.ipynb`
- train config: `experiments/anomaly_detection/patchcore/resnet18/x64/main/train_config.toml`
- data config: `experiments/anomaly_detection/patchcore/resnet18/x64/main/data_config.toml`
