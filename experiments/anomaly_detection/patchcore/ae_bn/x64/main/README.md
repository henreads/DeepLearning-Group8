...
Key files:
- notebook: `experiments/anomaly_detection/patchcore/ae_bn/x64/main/notebook.ipynb`
- train config: `experiments/anomaly_detection/patchcore/ae_bn/x64/main/train_config.toml`
- data config: `experiments/anomaly_detection/patchcore/ae_bn/x64/main/data_config.toml`
- artifact root: `experiments/anomaly_detection/patchcore/ae_bn/x64/main/artifacts/patchcore_ae_bn`
