# Teacher-Student ResNet18 x224 Main Modal Runner

This app runs the Teacher-Student ResNet18 x224 main experiment remotely through the Modal CLI.
...
```powershell
modal run modal_apps/teacher_student_resnet18_x224_main/app.py::upload_raw_data
```
...
```powershell
modal run modal_apps/teacher_student_resnet18_x224_main/app.py::main
```
